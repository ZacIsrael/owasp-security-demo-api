  ...
  return (
    <main style={{ padding: "2rem", fontFamily: "Arial, sans-serif" }}>
      ...
      <section>
        ...
        <p>
          Since the CSP header includes <code>style-src 'nonce-...'</code> and
          this <code>{`<style>`}</code> tag uses the same nonce, the browser
          will allow it.
        </p>

        {/* Inject inline CSS that will only be allowed if the nonce matches the CSP */}
        <style
          // Comment out the nonce to demonstrate CSP blocking this inline style
          nonce={nonce}
